...
2. Make your changes in the `src/` directory. The main component logic is in `src/dragble-editor.component.ts`.
...
- Use [GitHub Issues](https://github.com/Dragble/dragble-angular-editor/issues) to report bugs or request features.
