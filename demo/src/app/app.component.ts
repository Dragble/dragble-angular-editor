...
import type { EditorOptions } from "dragble-angular-editor";

@Component({
  selector: "app-root",
  standalone: true,
  imports: [CommonModule, DragbleEditorComponent],
  templateUrl: "./app.component.html",
  styleUrls: ["./app.component.css"],
})
export class AppComponent {
  @ViewChild("editor") editorComponent!: DragbleEditorComponent;
